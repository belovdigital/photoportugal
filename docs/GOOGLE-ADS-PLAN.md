> ⚠️ **Архив (март 2026).** Не отражает текущее состояние аккаунта: стратегия
> сменилась на Maximize Clicks (07.2026), аккаунт в USD. Живые факты — в памяти
> Клода (google_ads_access) и в самом аккаунте.
