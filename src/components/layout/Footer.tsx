      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-warm-200 pt-6">
          <div className="flex items-center justify-center gap-4">
            ...
            <a href="https://www.tiktok.com/@photoportugal_com" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-warm-100 text-gray-500 transition hover:bg-primary-100 hover:text-primary-600" aria-label="TikTok">
