...
export function PhotographerCatalog({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="sticky top-16 z-40 -mx-4 mt-3 border-b border-warm-200 bg-warm-50/95 px-4 py-2 backdrop-blur sm:hidden">
            ...
            <button
              ...
              className={`flex shrink-0 items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-semibold transition ${
                active
                  ...
                  : "border-warm-200 bg-white text-gray-700"
              }`}
            >
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium transition ${
                locationFilters.length > 0 ? "border-primary-300 bg-primary-50 text-primary-700" : "border-warm-200 bg-white text-gray-700 hover:border-primary-300 hover:text-primary-700"
              }`}
            >
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium transition ${
                secondaryCount > 0 ? "border-primary-300 bg-primary-50 text-primary-700" : "border-warm-200 bg-white text-gray-700 hover:border-primary-300 hover:text-primary-700"
              }`}
            >
              ...
              <svg className={`h-3 w-3 text-gray-400 transition ${showFiltersDropdown ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {activeFilterCount > 0 && (
            <button
              onClick={() => { setLocationFilters([]); setShootTypeFilters([]); setLanguageFilter(""); setBucketFlags(new Set()); setActiveBucket(null); }}
              className="rounded-full px-2.5 py-1 text-xs font-medium text-gray-500 transition hover:bg-gray-50"
            >
          ...
          <div className="relative ml-auto">
            ...
            {searchOpen && (
              <>
                {/* z-40/50 so the dropdown lands above photographer cards below. */}
