...
export function DashboardSidebar({ initialRole }: { initialRole?: string }) {
  ...
  const navItems: NavItem[] = [
    ...
    { href: "/dashboard/getting-started", labelKey: "sidebarGettingStarted", icon: "sparkles", roles: ["photographer"] },
    ...
    { href: "/dashboard/stats", labelKey: "sidebarStats", icon: "chart-bar", roles: ["photographer"] },
    ...
    { href: "/dashboard/gift-cards", labelKey: "sidebarGiftCards", icon: "gift", roles: ["photographer"] },
