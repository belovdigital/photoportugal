...
export const SCENES: Scene[] = [
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY to capture each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand together on a stone terrace in front of Pena Palace in Sintra, Portugal. The full colourful palace facade (yellow, red, blue domes) fills the background. They wear casual travel-tourist clothes, smiling naturally, looking at the camera. Warm golden-hour sunset light, soft mist in the distance. Composition: prefer a full-body or 3/4-length wide-angle group shot at ~28mm; if the reference is a tight head-shot or selfie, a confident portrait crop is also acceptable as long as the palace is clearly behind them. Photorealistic, depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "sintra",
  },
  {
    id: "algarve-benagil",
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on the Ribeira cobbled waterfront in Porto, Portugal. Behind them: colourful pastel-painted riverside houses on the left, the Douro river, and the iconic Dom Luís I iron bridge in the distance. They wear casual travel-tourist clothes, candid relaxed pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 28mm; a tighter portrait crop is acceptable for selfie-style references as long as the Dom Luís I bridge is clearly visible behind. Warm late-afternoon light, photorealistic, shallow depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "porto",
  },
  {
    id: "lisbon-tram",
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on a cobbled street in Alfama, Lisbon, Portugal. The iconic bright yellow Tram 28 is right behind them on its tracks. Traditional blue azulejo tiled walls flank the narrow street. They wear casual travel-tourist clothes, candid pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 28mm; a tighter portrait crop is acceptable for selfie-style references as long as the yellow Tram 28 is clearly visible behind them. Soft afternoon light, photorealistic, shallow depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "lisbon",
  },
  {
    id: "cabo-da-roca",
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on the cliff edge at Cabo da Roca, Portugal — the westernmost point of continental Europe. Behind them: dramatic cliffs plunging into the Atlantic Ocean, the historic red-and-white lighthouse in the distance. Windswept atmosphere, hair and clothes slightly blowing. They wear casual travel-tourist clothes (light jackets), confident pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 24-28mm; a tighter portrait crop is acceptable for selfie-style references as long as the cliff and Atlantic horizon are clearly visible behind. Soft golden-hour light, photorealistic, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference are on the golden-sand beach at Praia Dona Ana in Lagos, Algarve, Portugal. Behind them: dramatic ochre sandstone arches and rock formations rising from turquoise Atlantic surf. They wear casual beach clothes / light summer outfits, relaxed natural pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 28mm; a tighter portrait crop is acceptable for selfie-style references as long as the sandstone arches are clearly visible behind. Soft warm sunset light, photorealistic, shallow depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "algarve",
  },
  {
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on the boardwalk at Costa Nova, Portugal in front of the iconic palheiros — wooden fishermen's houses painted in vivid vertical candy-stripes (red, blue, yellow, green on white). They wear casual travel clothes, relaxed natural pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 28mm; a tighter portrait crop is acceptable for selfie-style references as long as several striped palheiros are clearly visible behind them. Soft warm afternoon light, photorealistic, shallow depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "aveiro",
  },
  {
    id: "douro-valley",
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on a stone terrace overlooking the Douro Valley, Portugal — dramatic terraced vineyards stepping down to the meandering Douro river far below, golden-green hillsides. They hold a glass of port wine, wear smart-casual travel clothes, relaxed natural pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 28-35mm; a tighter portrait crop is acceptable for selfie-style references as long as the terraced vineyards and river bend are clearly visible behind. Warm golden-hour light, photorealistic, shallow depth of field, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand at the Vista do Rei viewpoint above Sete Cidades on São Miguel island, Azores, Portugal. Behind them: the iconic twin crater lakes — one striking blue, one vivid green — separated by a narrow causeway, surrounded by lush volcanic mountains. They wear casual hiking-travel clothes (light jacket), confident pose, looking at the camera. Composition: prefer a full-body or 3/4-length wide-angle group shot at 24-28mm to capture both lakes; a tighter portrait crop is acceptable for selfie-style references as long as the twin-coloured lakes are clearly visible behind. Soft cloudy light with sun breaking through, photorealistic, 4K detail, square 1024×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "azores",
  },
  {
    id: "belem-tower",
