...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://photoportugal.com/photoshoots/${type}` },
    openGraph: {
      title: shootType.title,
      description: shootType.metaDescription,
      type: "website",
    ...
    <>
      ...
      <section className="bg-warm-50">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            ...
            >
              Find {shootType.name} Photographers
            </Link>
            <Link
              href="/how-it-works"
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <h2 className="font-display text-3xl font-bold text-gray-900">
          Best Locations for {shootType.name} Photography in Portugal
        </h2>
        <p className="mt-4 max-w-3xl text-gray-500">
          Our photographers operate across Portugal. Here are the top destinations
          for your {shootType.name.toLowerCase()} photoshoot.
        </p>
      ...
      <section className="border-y border-warm-200 bg-warm-50">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <h2 className="text-center font-display text-3xl font-bold text-gray-900">
            How to Book Your {shootType.name} Photoshoot
          </h2>
            ...
            {[
              {
                ...
                desc: `View portfolios of photographers experienced in ${shootType.name.toLowerCase()} photography across Portugal.`,
              },
              {
                step: "2",
                title: "Choose your package",
                desc: "Select a package that fits your needs. Most sessions range from 1-2 hours and include 40-100+ edited photos.",
              },
              {
                step: "3",
                title: "Book your session",
                desc: "Pick your date, time, and preferred location. Your photographer confirms within 24 hours.",
              },
              {
                step: "4",
      ...
      <section className="bg-gray-900">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
          <h2 className="font-display text-3xl font-bold text-white">
            Ready to Book Your {shootType.name} Photoshoot?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-gray-300">
            Browse verified photographers, compare portfolios and pricing, and book
            your perfect {shootType.name.toLowerCase()} session in minutes.
          </p>
          <Link
            href={`/photographers?shootType=${shootType.slug}`}
