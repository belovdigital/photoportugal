...
export default async function LocationsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const T = {
    en: { destinations: "destinations", photographers: "verified photographers", from: "From €", rating: "rating", reviews: "reviews", featuredHeading: "Top destinations", featuredSub: "Where most travelers shoot — and where photographers know every angle.", allHeading: `All destinations in ${country.areaServed}`, allSub: "From mountain villages to island volcanoes — pick where your story happens.", typesHeading: "Or browse by photoshoot type", typesSub: "Same destinations, organised by occasion.", finalCta: "Not sure where to shoot?", finalCtaSub: "Tell our concierge what you have in mind and we'll match you with 2–3 photographers in hours.", findCta: "Get matched", browseCta: "Browse all photographers", reviewsHeading: `What travelers say about ${country.areaServed} photographers`, reviewsSubHeading: "Verified reviews from real bookings across the country.", matchHeading: "AI photographer match — instant", matchSubtitle: `Describe your shoot — hand-picked ${country.areaServed} pros in under 10 seconds.`, matchPlaceholder: `e.g. couples shoot in Madrid next Friday at golden hour`, matchCta: "Get matches" },
    pt: { destinations: "destinos", photographers: "fotógrafos verificados", from: "Desde €", rating: "avaliação", reviews: "avaliações", featuredHeading: "Destinos principais", featuredSub: "Onde a maioria dos viajantes faz fotos — e onde os fotógrafos conhecem cada ângulo.", allHeading: `Todos os destinos em ${country.areaServed}`, allSub: "De aldeias serranas a vulcões insulares — escolha onde a sua história acontece.", typesHeading: "Ou explore por tipo de sessão", typesSub: "Os mesmos destinos, organizados por ocasião.", finalCta: "Não sabe onde fotografar?", finalCtaSub: "Conte ao nosso concierge o que tem em mente e vamos emparelhá-lo com 2–3 fotógrafos em poucas horas.", findCta: "Receber recomendações", browseCta: "Ver todos os fotógrafos", reviewsHeading: `O que dizem os viajantes sobre fotógrafos em ${country.areaServed}`, reviewsSubHeading: "Avaliações verificadas de reservas reais por todo o país.", matchHeading: "Match com fotógrafo por IA — instantâneo", matchSubtitle: "Descreva a sessão — profissionais portugueses em menos de 10 segundos.", matchPlaceholder: `ex.: sessão de casal em Madrid sexta à hora dourada`, matchCta: "Ver matches" },
    de: { destinations: "Orte", photographers: "verifizierte Fotografen", from: "Ab €", rating: "Bewertung", reviews: "Bewertungen", featuredHeading: "Top-Destinationen", featuredSub: "Wo die meisten Reisenden fotografieren — und wo Fotografen jeden Winkel kennen.", allHeading: `Alle Orte in ${country.areaServed}`, allSub: "Von Bergdörfern bis zu Inselvulkanen — wählen Sie den Ort Ihrer Geschichte.", typesHeading: "Oder nach Shooting-Art durchsuchen", typesSub: "Dieselben Orte, nach Anlass sortiert.", finalCta: "Sie wissen noch nicht, wo?", finalCtaSub: "Erzählen Sie unserem Concierge, was Sie sich vorstellen — wir vermitteln Ihnen 2–3 Fotografen innerhalb weniger Stunden.", findCta: "Vermittlung anfragen", browseCta: "Alle Fotografen ansehen", reviewsHeading: `Was Reisende über Fotografen in ${country.areaServed} sagen`, reviewsSubHeading: "Verifizierte Bewertungen von echten Buchungen im ganzen Land.", matchHeading: "KI-Fotografen-Match — sofort", matchSubtitle: `Beschreiben Sie Ihr Shooting — handverlesene ${country.areaServed}-Profis in unter 10 Sekunden.`, matchPlaceholder: "z. B. Paar-Shooting in Lissabon am Freitag zur goldenen Stunde", matchCta: "Vorschläge holen" },
    es: { destinations: "destinos", photographers: "fotógrafos verificados", from: "Desde €", rating: "valoración", reviews: "reseñas", featuredHeading: "Destinos destacados", featuredSub: "Donde la mayoría de los viajeros toman fotos — y donde los fotógrafos conocen cada ángulo.", allHeading: `Todos los destinos en ${ES_NAME}`, allSub: "De pueblos de montaña a volcanes insulares — elija dónde sucede su historia.", typesHeading: "O explore por tipo de sesión", typesSub: "Los mismos destinos, organizados por ocasión.", finalCta: "¿No sabe dónde fotografiar?", finalCtaSub: "Cuéntele a nuestro concierge lo que tiene en mente y le emparejaremos con 2–3 fotógrafos en pocas horas.", findCta: "Recibir recomendaciones", browseCta: "Ver todos los fotógrafos", reviewsHeading: `Lo que dicen los viajeros sobre fotógrafos en ${ES_NAME}`, reviewsSubHeading: "Reseñas verificadas de reservas reales en todo el país.", matchHeading: "Match con fotógrafo por IA — al instante", matchSubtitle: `Describa su sesión — profesionales de ${ES_NAME} en menos de 10 segundos.`, matchPlaceholder: `p. ej. sesión de pareja en Madrid el viernes a la hora dorada`, matchCta: "Ver matches" },
    fr: { destinations: "destinations", photographers: "photographes vérifiés", from: "À partir de €", rating: "note", reviews: "avis", featuredHeading: "Destinations phares", featuredSub: "Là où la plupart des voyageurs photographient — et où les photographes connaissent chaque angle.", allHeading: `Toutes les destinations au ${country.areaServed}`, allSub: "Des villages de montagne aux volcans insulaires — choisissez où se déroule votre histoire.", typesHeading: "Ou parcourez par type de séance", typesSub: "Les mêmes destinations, classées par occasion.", finalCta: "Vous ne savez pas où photographier ?", finalCtaSub: "Dites à notre concierge ce que vous avez en tête et nous vous proposerons 2–3 photographes en quelques heures.", findCta: "Être mis en relation", browseCta: "Voir tous les photographes", reviewsHeading: `Ce que les voyageurs disent des photographes au ${country.areaServed}`, reviewsSubHeading: "Avis vérifiés issus de vraies réservations partout dans le pays.", matchHeading: "Mise en relation par IA — instantanée", matchSubtitle: `Décrivez votre séance — photographes du ${country.areaServed} en moins de 10 secondes.`, matchPlaceholder: `ex. séance couple à Madridne vendredi à l'heure dorée`, matchCta: "Voir les matches" },
  } as const;
