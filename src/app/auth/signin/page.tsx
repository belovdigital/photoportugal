      ...
      <div className="w-full max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-500">
            Sign in to your Photo Portugal account
          </p>
        </div>

        <div className="mt-8 rounded-2xl border border-warm-200 bg-white p-8 shadow-sm">
          {/* Google Sign In */}
          <button className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
