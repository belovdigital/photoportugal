...
export function ConciergeInvitePlaque({
  ...
  // Header was removed: the drawer that opens on submit greets the visitor as
  // Lens and explains the AI immediately, so duplicating the persona on the
  // plaque just clutters the hero. Chips + placeholder carry the affordance.
  const containerCls = isDark
    ? "rounded-2xl border border-white/20 bg-white/10 p-3.5 shadow-xl backdrop-blur-md sm:p-4"
    : "rounded-2xl border border-warm-200 bg-white p-3.5 shadow-md sm:p-4";
