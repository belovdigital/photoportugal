          ...
          {data.thumbnails.length > 1 && (
            <>
              <button
                onClick={() => scrollBy(-1)}
                aria-label="Previous photo"
                className="absolute left-2 top-1/2 -translate-y-1/2 hidden lg:flex opacity-0 group-hover/breakout:opacity-100 transition h-9 w-9 items-center justify-center rounded-full bg-white/30 backdrop-blur text-white hover:bg-white/50"
              >
              ...
              <button
                onClick={() => scrollBy(1)}
                aria-label="Next photo"
                className="absolute right-2 top-1/2 -translate-y-1/2 hidden lg:flex opacity-0 group-hover/breakout:opacity-100 transition h-9 w-9 items-center justify-center rounded-full bg-white/30 backdrop-blur text-white hover:bg-white/50"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
