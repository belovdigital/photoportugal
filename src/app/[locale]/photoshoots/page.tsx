...
// schema.org value and is always English, which produced "photographes du
// Spain" and "handverlesene Spain-Profis" on the live French and German pages.
          ...
          <div className="grid grid-cols-1 items-start gap-8 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12 lg:py-20">
            <div className="max-w-xl lg:sticky lg:top-24">
              ...
              {/* AI-led match panel with sparkle icon — same visual
                  family as /locations/[slug] hero, just on light bg. */}
              <div className="mt-7">
                ...
                <p className="mb-3 text-[12px] text-gray-500">{tt.matchSubtitle}</p>
                <ConciergeQuickStart
                  variant="light"
