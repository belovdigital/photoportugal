        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://instagram.com/photoportugal" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 transition hover:text-primary-600">
              ...
              <a href="https://facebook.com/photoportugal" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 transition hover:text-primary-600">
