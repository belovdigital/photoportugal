    ...
    itemListElement: [
      {
        ...
        price: "0",
        priceCurrency: "EUR",
        description: `Up to 500 portfolio images, ${COMMISSION_RATES.free}% commission`,
      },
      {
        "@type": "Offer",
        name: "Pro Plan",
        ...
        description: `Up to 500 portfolio images, ${COMMISSION_RATES.pro}% commission`,
      },
      {
        "@type": "Offer",
        name: "Premium Plan",
        ...
        description: `Up to 500 portfolio images, ${COMMISSION_RATES.premium}% commission`,
      },
    ],
  };
