...
export const SCENES: Scene[] = [
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference are on the golden-sand beach at Praia Dona Ana in Lagos, Algarve, Portugal. Behind them: dramatic ochre sandstone arches and rock formations rising from turquoise Atlantic surf. They wear casual beach clothes / light summer outfits, relaxed natural pose, with relaxed natural smiles (if anyone in the reference looks neutral or sad, give them a soft warm smile while keeping their identity intact), looking at the camera. Composition: prefer an ENVIRONMENTAL travel shot — wide enough that the people occupy roughly the lower 50-60% of the frame height (NOT a tight close-up); plenty of the landmark and surroundings clearly visible. Full-body or 3/4-length group shot at 24mm; a tighter portrait crop is acceptable for selfie-style references as long as the sandstone arches are clearly visible behind. Soft warm sunset light, photorealistic, shallow depth of field, 4K detail, landscape 1536×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "algarve",
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference are on a stone bridge or quayside along the canals of Aveiro, Portugal. Beside them: a brightly hand-painted traditional moliceiro boat (yellow, red, blue) on calm reflective water; pastel canal-side houses behind. They wear casual travel-tourist clothes, candid relaxed pose, with relaxed natural smiles (if anyone in the reference looks neutral or sad, give them a soft warm smile while keeping their identity intact), looking at the camera. Composition: prefer an ENVIRONMENTAL travel shot — wide enough that the people occupy roughly the lower 50-60% of the frame height (NOT a tight close-up); plenty of the landmark and surroundings clearly visible. Full-body or 3/4-length group shot at 24mm; a tighter portrait crop is acceptable for selfie-style references as long as the painted moliceiro boat is clearly visible. Soft afternoon light, photorealistic, shallow depth of field, 4K detail, landscape 1536×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "aveiro",
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on the boardwalk at Costa Nova, Portugal in front of the iconic palheiros — wooden fishermen's houses painted in vivid vertical candy-stripes (red, blue, yellow, green on white). They wear casual travel clothes, relaxed natural pose, with relaxed natural smiles (if anyone in the reference looks neutral or sad, give them a soft warm smile while keeping their identity intact), looking at the camera. Composition: prefer an ENVIRONMENTAL travel shot — wide enough that the people occupy roughly the lower 50-60% of the frame height (NOT a tight close-up); plenty of the landmark and surroundings clearly visible. Full-body or 3/4-length group shot at 24mm; a tighter portrait crop is acceptable for selfie-style references as long as several striped palheiros are clearly visible behind them. Soft warm afternoon light, photorealistic, shallow depth of field, 4K detail, landscape 1536×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "aveiro",
  },
  {
    id: "douro-valley",
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on a stone terrace overlooking the Douro Valley, Portugal — dramatic terraced vineyards stepping down to the meandering Douro river far below, golden-green hillsides. They hold a glass of port wine, wear smart-casual travel clothes, relaxed natural pose, with relaxed natural smiles (if anyone in the reference looks neutral or sad, give them a soft warm smile while keeping their identity intact), looking at the camera. Composition: prefer an ENVIRONMENTAL travel shot — wide enough that the people occupy roughly the lower 50-60% of the frame height (NOT a tight close-up); plenty of the landmark and surroundings clearly visible. Full-body or 3/4-length group shot at 24mm; a tighter portrait crop is acceptable for selfie-style references as long as the terraced vineyards and river bend are clearly visible behind. Warm golden-hour light, photorealistic, shallow depth of field, 4K detail, landscape 1536×1024. NEVER drop or duplicate anyone.",
  ...
  },
  {
    ...
    prompt:
      "Generate a brand-new travel photograph featuring EVERY person from the reference image. Use the reference ONLY for each person's face, hair, skin tone, age and gender — keep every face identical to the reference. Body, pose, clothes and framing must be newly generated. Setting: all people from the reference stand on the riverside walkway in Belém, Lisbon, Portugal with the iconic Belém Tower (Torre de Belém) — the ornate 16th-century Manueline limestone tower — clearly visible on the Tagus river behind them. They wear casual travel-tourist clothes, candid relaxed pose, with relaxed natural smiles (if anyone in the reference looks neutral or sad, give them a soft warm smile while keeping their identity intact), looking at the camera. Composition: prefer an ENVIRONMENTAL travel shot — wide enough that the people occupy roughly the lower 50-60% of the frame height (NOT a tight close-up); plenty of the landmark and surroundings clearly visible. Full-body or 3/4-length group shot at 24mm; a tighter portrait crop is acceptable for selfie-style references as long as Belém Tower is clearly visible behind. Soft warm afternoon light, photorealistic, shallow depth of field, 4K detail, landscape 1536×1024. NEVER drop or duplicate anyone.",
    conciergeLoc: "lisbon",
  },
  {
    id: "evora-temple",
