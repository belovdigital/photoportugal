    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="text-center">
        ...
        <h2 className="mt-3 font-display text-3xl font-bold text-gray-900 sm:text-4xl">
          Top Photographers in Portugal
        </h2>
        <p className="mt-3 text-lg text-gray-500">
          Hand-picked professionals for unforgettable photos
        </p>
      </div>
          ...
          >
            ...
            <div className="p-4 pt-8">
              ...
              <div className="mt-3 flex items-center justify-between border-t border-warm-100 pt-3">
                {(p.min_price || p.hourly_rate) ? (
                  <span className="text-sm">
                    <span className="text-gray-400">From </span>
                    <span className="font-bold text-gray-900">&euro;{p.min_price || p.hourly_rate}</span>
                  </span>
                ) : (
