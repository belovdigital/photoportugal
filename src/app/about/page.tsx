        ...
        <div className="space-y-8 text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-4">
              ...
              session in minutes. Your photographer will meet you at the location, guide you to the
              most photogenic spots, and make the whole experience relaxed and fun. Within a few days,
              you&apos;ll receive professionally edited photos delivered through our secure gallery — ready
              to share, print, or treasure forever.
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          {[
            ...
            },
            {
              ...
              text: "Pay with cards, Apple Pay, or Google Pay. Your money is held safely until photos are delivered — so you're always protected.",
